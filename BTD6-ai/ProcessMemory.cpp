...
//
//
//////Doesn't work for BTD 6  SEARCH FOR VALUE NOT READ FOR VALUE
////////https://www.cheatengine.org/forum/viewtopic.php?t=594721&sid=ae3fce06e7e08b8cae23afd8c2141974
////DWORD64 ProcessMemory::ReadOffsets(HANDLE handle, unsigned long long baseAddress, std::vector<long> offsets)
////{
////	unsigned long long finalAddress = 0;
////	unsigned long long  tempAddress = 0;
////
////	std::cout << LPCVOID(baseAddress + offsets[0]) << "\n";
////	bool success = ReadProcessMemory(handle, LPCVOID(baseAddress + offsets[0]), &finalAddress, sizeof(finalAddress), NULL);
////	tempAddress = finalAddress;
////	std::cout << (void*)finalAddress << std::endl;
////
////	for (int i = 1; i < offsets.size() - 1; i++)
////	{
////		bool success = ReadProcessMemory(handle, (char*)(tempAddress + offsets[i]), &finalAddress, sizeof(finalAddress), NULL);
////		if (!success)
////		{
...
///// <param name="size">Size of the memory region</param>
///// <returns></returns>
//char* ProcessMemory::ScanForALongValue(HANDLE handle, long answer, char* baseAddress, intptr_t size)
//{
//	long value;
//	for (char* curr = baseAddress; curr < baseAddress + size; curr += 8)
//	{
...
///// <param name="size">Size of the memory region</param>
///// <returns></returns>
//void ProcessMemory::ScanForLongValues(HANDLE handle, long answer, char* baseAddress, intptr_t size, std::vector <char*> results)
//{
//	long value;
//	for (char* curr = baseAddress; curr < baseAddress + size; curr += 8)
//	{
